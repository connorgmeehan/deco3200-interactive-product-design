...
export ASCII_DISPLAY_SERVER_PORT=3000

export FACE_POINTS_DISPLAY_SERVER_ADDR=localhost
export FACE_POINTS_DISPLAY_SERVER_PORT=3000

export GENDER_DISPLAY_SERVER_ADDR=localhost
export GENDER_DISPLAY_SERVER_PORT=3000

export EMOTION_DISPLAY_SERVER_ADDR=localhost
export EMOTION_DISPLAY_SERVER_PORT=3000

export LIST_DISPLAY_SERVER_ADDR=localhost
export LIST_DISPLAY_SERVER_PORT=3000
